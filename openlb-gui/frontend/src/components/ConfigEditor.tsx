      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {saveStatus === 'saved' ? 'Saved' : saveStatus === 'error' ? 'Failed' : (
              <>
                {isDirty ? 'Save*' : 'Save'}
                <kbd className="hidden md:inline-block px-1.5 py-0.5 text-[10px] font-mono bg-black/20 rounded opacity-80">Ctrl+S</kbd>
              </>
            )}
          </button>
        </div>
