...
const ConfigEditor: React.FC<ConfigEditorProps> = ({ initialContent, onSave, className }) => {
  // Optimization: Use uncontrolled component to avoid re-renders on every keystroke.
  // This significantly improves typing performance for large configuration files.
